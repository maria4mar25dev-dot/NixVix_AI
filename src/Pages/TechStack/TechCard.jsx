...
function TechCards() {
  return (
    <div className="relative z-[1] -mt-[80px] sm:-mt-[30px] md:mt-0 flex flex-col items-center justify-center w-full py-0 sm:py-0 md:py-10 lg:py-20 bg-[radial-gradient(circle_closest-side_at_center,rgba(0,198,167,0.25)_0%,#0c0c0c_80%)] overflow-hidden">
      {/* Section Titles */}
      ...
      <div className="relative w-full overflow-hidden ">
        <div className="flex gap-2 sm:gap-2 md:gap-4 animate-scroll  items-start">
          {[...techData, ...techData].map((item, index) => (
            <div
              key={index}
              className="flex flex-col justify-start items-start bg-[#111] rounded-xl w-[110px] sm:w-[110px] md:w-[150px] lg:w-[190px]  p-2 sm:p-2 md:p-4  sm:h-[150px]  md:h-[154px]   lg:h-[180px] sm:hover:h-[180px] md:hover:h-[200px] lg:hover:h-[230px]   cursor-pointer  transition-all duration-500 hover:bg-gradient-to-br hover:from-[#0C0C0C] hover:to-[rgba(0,198,167,0.2)] hover:shadow-[0_8px_25px_rgba(0,0,0,0.4)] transform hover:-translate-y-1 group"
            >
              {/* Icon */}
